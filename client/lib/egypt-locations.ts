...
export const egyptGovernorates: Governorate[] = [
  ...
  },
  {
    ...
    cities: [
      ...
      { name: 'Al Badrashein', nameAr: 'البدرشين' },
      { name: 'Al Saff', nameAr: 'الصف' },
      { name: 'Atfih', nameAr: 'أطفيح' },
      { name: 'Al Ayat', nameAr: 'العياط' },
      { name: 'Kerdasa', nameAr: 'كرداسة' },
      { name: 'Abu Nomros', nameAr: 'أبو النمرس' },
      { name: 'Manshiyet Al Qanater', nameAr: 'منشأة القناطر' },
      { name: 'Ausim', nameAr: 'أوسيم' },
    ],
  },
  {
    name: 'Alexandria',
  ...
  },
  {
    ...
    cities: [
      ...
      { name: 'Gamasa', nameAr: 'الجمالية' },
      { name: 'Menit El Nasr', nameAr: 'منية النصر' },
      { name: 'Nabaroh', nameAr: 'نبروه' },
      { name: 'Sinbillawein', nameAr: 'السنبلاوين' },
      { name: 'Tami El Amdid', nameAr: 'تمي الأمديد' },
    ],
  },
  {
    name: 'Beheira',
    ...
    cities: [
      ...
      { name: 'Abu El Matamir', nameAr: 'أبو المطامير' },
      { name: 'Delengat', nameAr: 'الدلنجات' },
      { name: 'Mahmoudiyah', nameAr: 'المحمودية' },
      { name: 'Rahmaniya', nameAr: 'الرحمانية' },
      { name: 'Itay El Barud', nameAr: 'إيتاي البارود' },
      { name: 'Housh Eissa', nameAr: 'حوش عيسى' },
      { name: 'Shubrakhit', nameAr: 'شبراخيت' },
      { name: 'Kom Hamada', nameAr: 'كوم حمادة' },
      { name: 'Badr', nameAr: 'بدر' },
      { name: 'Wadi El Natrun', nameAr: 'وادي النطرون' },
    ],
  },
  {
    name: 'Gharbia',
    ...
    cities: [
      ...
      { name: 'Kotour', nameAr: 'قطور' },
      { name: 'Santa', nameAr: 'سنتا' },
    ],
  },
  {
    name: 'Monufia',
  ...
  },
  {
    ...
    cities: [
      ...
      { name: 'Biyala', nameAr: 'بيلا' },
      { name: 'Riyadh', nameAr: 'الرياض' },
      { name: 'Hamoul', nameAr: 'الحامول' },
    ],
  },
  {
    name: 'Damietta',
